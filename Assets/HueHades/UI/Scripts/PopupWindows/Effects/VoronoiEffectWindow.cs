...
public class VoronoiEffectWindow : EffectWindow
{
    private VoronoiEffect _effect;
    ...
    public VoronoiEffectWindow(HueHadesWindow window) : base(window)
    {
        _seed = new SliderInt();
        _seed.label = "Seed   ";
        _seed.lowValue = -1000000;
